...
namespace Advanced_Ecommerce.DataAccess.Migrations
{
    ...
    [Migration("20230224123821_initial_create")]
            ...
            modelBuilder.Entity("Advanced_Ecommerce.Entities.Concrete.Brand", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 15, 38, 20, 913, DateTimeKind.Local).AddTicks(3524));
            ...
            modelBuilder.Entity("Advanced_Ecommerce.Entities.Concrete.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 15, 38, 20, 913, DateTimeKind.Local).AddTicks(4326));
