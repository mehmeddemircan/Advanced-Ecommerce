...
namespace Advanced_Ecommerce.DataAccess.Migrations
{
    ...
    [Migration("20230224125139_edit_user_table2")]
    partial class edit_user_table2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Advanced_Ecommerce.Entities.Concrete.Brand", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 15, 51, 39, 803, DateTimeKind.Local).AddTicks(9756));
            ...
            modelBuilder.Entity("Advanced_Ecommerce.Entities.Concrete.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 15, 51, 39, 804, DateTimeKind.Local).AddTicks(588));
